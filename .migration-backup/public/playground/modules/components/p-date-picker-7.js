...
// src/components/p-date-picker-7.tsx
...
function Particle() {
  ...
  return /* @__PURE__ */ jsxs(Popover, { children: [
    /* @__PURE__ */ jsxs(
      PopoverTrigger,
      {
        render: /* @__PURE__ */ jsx4(Button, { className: "w-full justify-start", variant: "outline" }),
        children: [
          /* @__PURE__ */ jsx4(CalendarIcon, { className: "shrink-0" }),
          /* @__PURE__ */ jsx4("span", { className: "flex flex-wrap gap-1", children: dates && dates.length > 0 ? /* @__PURE__ */ jsxs(Fragment, { children: [
            dates.slice(0, 3).map((date) => /* @__PURE__ */ jsx4(Badge, { variant: "secondary", children: format(date, "MMM d") }, date.toISOString())),
            dates.length > 3 && /* @__PURE__ */ jsxs(Badge, { variant: "secondary", children: [
              "+",
              dates.length - 3
            ] })
          ] }) : /* @__PURE__ */ jsx4("span", { children: "Pick dates" }) })
        ]
      }
    ),
    /* @__PURE__ */ jsx4(PopoverPopup, { children: /* @__PURE__ */ jsx4(Calendar, { mode: "multiple", onSelect: setDates, selected: dates }) })
  ] });
}
export {
  Particle as default
