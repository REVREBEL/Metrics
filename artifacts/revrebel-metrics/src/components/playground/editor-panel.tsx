            ...
            <PopoverTrigger asChild>
              <InputGroupAddon>
                <InputGroupButton
                  ...
                  aria-label="Info"
                >
                  <HugeiconsIcon icon={IconInfoCircle} />
                </InputGroupButton>
              </InputGroupAddon>
            </PopoverTrigger>
          <PopoverContent
      ...
      <InputGroup>
        ...
        <InputGroupAddon align="inline-end">
          <div className="bg-primary text-foreground flex size-4 items-center justify-center rounded-full">
            <HugeiconsIcon icon={IconCheck} className="size-3 text-white" />
          </div>
        </InputGroupAddon>
      </InputGroup>
    </div>
