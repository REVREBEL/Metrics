...
const PresetPickerLazy = React.lazy(() =>
  import("@/components/playground/preset-picker").then((m) => ({ default: m.PresetPicker }))
);
function PresetPicker(props: any) {
  return <Suspense fallback={null}><PresetPickerLazy {...props} /></Suspense>;
}
