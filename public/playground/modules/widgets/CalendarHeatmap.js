...
// src/widgets/CalendarHeatmap/index.tsx
...
function TooltipTrigger({
  ...
  return /* @__PURE__ */ jsx2(TooltipPrimitive.Trigger, { "data-slot": "tooltip-trigger", ...props, children });
}
...
function CalendarHeatmap({
  ...
  const [heatmapData, setHeatmapData] = useState2([]);
  ...
  const heatmapModify = (dataToModify) => {
    const zero = [];
    const one = [];
    const two = [];
    const three = [];
  ...
  const HeatmapLegend = () => {
    return /* @__PURE__ */ jsxs("div", { className: "flex space-x-2 text-sm text-gray-600", children: [
      /* @__PURE__ */ jsx5("span", { children: "less" }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-1", children: [
        /* @__PURE__ */ jsx5(
          "div",
          {
            className: cn(
              "h-[var(--box-size)] w-[var(--box-size)] rounded-sm",
  ...
  if (isInitializing || loading) {
    return /* @__PURE__ */ jsx5(Skeleton, { className: "h-[238px] w-full" });
  }
  if (error) {
    return /* @__PURE__ */ jsx5("div", { className: "flex h-[238px] w-full items-center justify-center rounded-md border", children: /* @__PURE__ */ jsx5("p", { className: "text-sm font-medium text-destructive", children: "Failed to load heatmap." }) });
  }
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3", children: [
          /* @__PURE__ */ jsx5("h3", { className: "text-base font-semibold", children: "Activity Heatmap" }),
          /* @__PURE__ */ jsx5(Tabs, { defaultValue: "90d", className: "w-auto", children: /* @__PURE__ */ jsxs(TabsList, { children: [
            /* @__PURE__ */ jsx5(TabsTrigger, { value: "1d", children: "Last 01 day" }),
            /* @__PURE__ */ jsx5(TabsTrigger, { value: "3d", children: "Last 03 days" }),
            /* @__PURE__ */ jsx5(TabsTrigger, { value: "7d", children: "Last 07 days" }),
            /* @__PURE__ */ jsx5(TabsTrigger, { value: "14d", children: "Last 14 days" }),
            /* @__PURE__ */ jsx5(TabsTrigger, { value: "30d", children: "Last 30 days" }),
            /* @__PURE__ */ jsx5(TabsTrigger, { value: "60d", children: "Last 60 days" }),
            /* @__PURE__ */ jsx5(TabsTrigger, { value: "90d", children: "Last 90 days" })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "overflow-x-scroll px-3 pb-3", children: [
          /* @__PURE__ */ jsx5(
            Calendar,
            {
              ...
              components: {
                Weekdays: () => /* @__PURE__ */ jsx5(Fragment, {}),
                Week: (props) => /* @__PURE__ */ jsx5(CustomRow, { weekProps: props, dataMap })
              }
            }
          ),
          /* @__PURE__ */ jsx5("div", { className: "mt-2 flex w-full justify-end pr-4", children: /* @__PURE__ */ jsx5(HeatmapLegend, {}) })
        ] })
      ]
    }
  );
}
function CustomRow({ weekProps, dataMap }) {
  ...
  return /* @__PURE__ */ jsx5(TooltipProvider, { children: /* @__PURE__ */ jsx5(
    "tr",
    {
      className: cn(
        classNames.tr,
        thisMonth !== monthOfData && "last:-mr-[calc(var(--box-margin)+var(--box-size))]"
      ),
      style: {
        "--box-size": DAY_SIZE,
        "--box-margin": DAY_MARGIN,
      ...
      children: days.map((day) => /* @__PURE__ */ jsxs(Tooltip, { children: [
        /* @__PURE__ */ jsx5(TooltipPopup, { children: `${dataMap.get(day.date.toISOString().split("T")[0]) || "No"} activities on ${day.date.toDateString()}` }),
        /* @__PURE__ */ jsx5(TooltipTrigger, { className: "cursor-default", children: /* @__PURE__ */ jsx5(
          "td",
          {
