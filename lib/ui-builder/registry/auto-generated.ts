...
import { MetricTrendIcon } from "@/widgets/_shared/MetricTrendIcon";
import { MetricLayout } from "@/widgets/_shared/MetricLayout";
import { MetricCardShell } from "@/widgets/_shared/MetricCardShell";
import { MetricCard } from "@/widgets/_shared/MetricCard";
import Page from "@/widgets/TimelineComponent/page";
...
export const autoGeneratedDefinitions: Record<string, any> = {
  ...
  SessionsCard: {
    ...
    from: "@/widgets/metric-cards/SessionsCard",
  },
  ...
  RevenueCard: {
    ...
    from: "@/widgets/metric-cards/RevenueCard",
  },
  ...
  ProfitCard: {
    ...
    from: "@/widgets/metric-cards/ProfitCard",
  },
  ...
  OverviewCard: {
    ...
    from: "@/widgets/metric-cards/OverviewCard",
  },
  ...
  GrowthCard: {
    ...
    from: "@/widgets/metric-cards/GrowthCard",
  },

  MetricTrendIcon: {
    component: MetricTrendIcon,
    schema: z.object({
      className: z.string().optional(),
    }),
    from: "@/widgets/_shared/MetricTrendIcon",
  },

  MetricLayout: {
    component: MetricLayout,
    schema: z.object({
      className: z.string().optional(),
    }),
    from: "@/widgets/_shared/MetricLayout",
  },

  MetricCardShell: {
    component: MetricCardShell,
    schema: z.object({
      className: z.string().optional(),
    }),
    from: "@/widgets/_shared/MetricCardShell",
  },
  ...
  Page: {
    ...
    from: "@/widgets/TimelineComponent/page",
  },
