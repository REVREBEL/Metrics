...
function PopoverTrigger({ className, children, asChild = false, ...props }: PopoverPrimitive.Trigger.Props & { asChild?: boolean }) {
...
export { PopoverAnchor, PopoverCreateHandle, Popover, PopoverTrigger, PopoverPopup, PopoverPopup as PopoverContent, PopoverHeader, PopoverTitle, PopoverDescription, PopoverClose, PopoverPrimitive };
