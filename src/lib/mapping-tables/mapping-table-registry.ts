...
const sourceApplicationDependency = "metrics_core.lkp_source_application"
...
export const mappingTableRegistry: MappingTableRegistryEntry[] = [
  {
    ...
    description:
      "Connects property identifiers to standard hotel records. A source application is not required for hotel identity mapping.",
    category: "Hotel",
  ...
  },
  {
    ...
    description:
      "Maps source-application segment codes to standardized commercial and finance segment values.",
    category: "Segment",
    bigQueryDataset: "metrics_core",
    bigQueryTable: "map_segment",
    primaryKey: "id",
    sourceApplicationField: "source_application_code",
    sourceCodeField: "source_code",
    sourceNameField: "source_value",
    standardValueField: "standard_code",
    lookupTableDependencies: [sourceApplicationDependency, "metrics_core.lkp_segment"],
    scope: "portfolio",
    supportsDrafts: true,
    supportsPublish: true,
    supportsUnmappedQueue: true,
  ...
  },
  {
    ...
    description:
      "Connects source-application booking-channel values to the standard channel taxonomy.",
    category: "Channel",
    bigQueryDataset: "metrics_core",
    ...
    sourceNameField: "source_value",
    standardValueField: "standard_code",
    lookupTableDependencies: [sourceApplicationDependency, "metrics_core.lkp_channel"],
    scope: "portfolio",
    supportsDrafts: true,
    supportsPublish: true,
    supportsUnmappedQueue: true,
  ...
  },
  {
    ...
    description:
      "Maps source-application room type values to standard room type, room class, bed type, and room pool values.",
    category: "Room Type",
    bigQueryDataset: "metrics_core",
    ...
    sourceNameField: "source_value",
    standardValueField: "standard_code",
    lookupTableDependencies: [sourceApplicationDependency, "metrics_core.lkp_roomtype"],
    scope: "portfolio",
    supportsDrafts: true,
    supportsPublish: true,
    supportsUnmappedQueue: true,
  ...
  },
  {
    ...
    description:
      "Maps source-application source and subsource values to standardized source, subsource, channel, and campaign groupings.",
    category: "Source",
    bigQueryDataset: "metrics_core",
  ...
  },
  {
    ...
    description:
      "Normalizes source-application market codes into the standard market and commercial grouping taxonomy.",
    category: "Market",
    bigQueryDataset: "metrics_core",
  ...
  },
  {
    ...
    description:
      "Maps source-application rate codes to standard rate, rate type, company, segment, channel, source, and subsource values.",
    category: "Rate",
    bigQueryDataset: "metrics_core",
  ...
  },
  {
    ...
    description:
      "Placeholder: Maps source-application agency and account codes to standard agency records. Not yet in fixtures.",
    category: "Agency",
    bigQueryDataset: "metrics_core",
    ...
    sourceNameField: "source_value",
    standardValueField: "standard_code",
    lookupTableDependencies: [sourceApplicationDependency],
    scope: "portfolio",
