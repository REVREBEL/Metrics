...
export const permissionsRegistry: PermissionDefinition[] = [
  ...
  {
    key: "data_library.lookup_tables.review",
    label: "Review Lookup Table Changes",
    description: "Approve or reject submitted lookup table change requests.",
    group: "Data Library — Lookup Tables",
    scope: "action",
    riskLevel: "high",
    defaultEnabledForDev: true,
  ...
  {
    key: "data_library.mapping_tables.review",
    label: "Review Mapping Table Changes",
    description: "Approve or reject submitted mapping table change requests.",
    group: "Data Library — Mapping Tables",
    scope: "action",
    riskLevel: "high",
    defaultEnabledForDev: true,
